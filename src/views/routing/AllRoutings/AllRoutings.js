        ...
        <div>
            ...
            <div className="card">
                ...
                <DataTable ref={dt} value={routings} selection={selectedProducts} onSelectionChange={(e) => setSelectedProducts(e.value)}
                        ...
                        currentPageReportTemplate="Showing {first} to {last} of {totalRecords} routings" globalFilter={globalFilter} header={header}>
                    ...
                    {/* <Column body={actionBodyTemplate} exportable={false} style={{ minWidth: '12rem' }}></Column>çà */}
                </DataTable>
            </div>
